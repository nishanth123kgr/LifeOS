...
export default function EditHabitPage() {
  ...
  useEffect(() => {
    if (habit) {
      ...
      } else if (lowerName.includes('read') || lowerName.includes('learn') || lowerName.includes('study')) {
        setSelectedCategory('learning');
      } else if (lowerName.includes('meditat') || lowerName.includes('mindful') || lowerName.includes('breath')) {
        setSelectedCategory('mindfulness');
      } else if (lowerName.includes('morning') || lowerName.includes('wake')) {
        setSelectedCategory('morning');
      } else if (lowerName.includes('evening') || lowerName.includes('night') || lowerName.includes('bed')) {
        setSelectedCategory('evening');
      } else if (lowerName.includes('water') || lowerName.includes('vitamin') || lowerName.includes('eat') || lowerName.includes('food')) {
        setSelectedCategory('nutrition');
      } else if (lowerName.includes('health') || lowerName.includes('sleep')) {
              ...
              {step === 2 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  <Card className="p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                      Adjust how often you do this habit
                    </p>
                  ...
                  {/* Motivation Card */}
                  <Card className="p-5 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-purple-200/50 dark:border-purple-800/50">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-purple-800 dark:text-purple-300 mb-2">Keep Your Streak! 🔥</h4>
                        <p className="text-sm text-purple-700 dark:text-purple-400">
                          Consistency is key. Every day you complete your habit brings you closer to making it automatic.
                        </p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <div className="flex justify-between">
                    ...
                    <Button type="submit" isLoading={updateMutation.isPending} className="px-8">
          ...
          <div className="lg:sticky lg:top-6 space-y-6 h-fit">
                    ...
                    {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, i) => (
                      <div key={i} className="flex flex-col items-center gap-1">
                        ...
                        <div className={cn(
                          ...
                          i < 3 
                            ? `bg-gradient-to-br ${selectedCategoryData.color} text-white`
            ...
            <Card className="p-5 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-amber-200/50 dark:border-amber-800/50">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-amber-800 dark:text-amber-300 mb-2">Pro Tip</h4>
                  <ul className="text-sm text-amber-700 dark:text-amber-400 space-y-1">
                    <li>• Adjust targets based on your progress</li>
                    <li>• Don't break the chain - stay consistent</li>
