...
const goalTypes = [
  ...
  { value: 'SAVINGS', label: 'Savings', icon: PiggyBank, color: 'from-green-500 to-emerald-500', bgLight: 'bg-green-50', bgDark: 'dark:bg-green-900/20', iconColor: 'text-green-600' },
  { value: 'INVESTMENT', label: 'Investment', icon: TrendingUp, color: 'from-indigo-500 to-purple-500', bgLight: 'bg-indigo-50', bgDark: 'dark:bg-indigo-900/20', iconColor: 'text-indigo-600' },
  { value: 'DEBT_PAYOFF', label: 'Debt Payoff', icon: Target, color: 'from-red-500 to-orange-500', bgLight: 'bg-red-50', bgDark: 'dark:bg-red-900/20', iconColor: 'text-red-600' },
  { value: 'PURCHASE', label: 'Purchase', icon: Gift, color: 'from-cyan-500 to-blue-500', bgLight: 'bg-cyan-50', bgDark: 'dark:bg-cyan-900/20', iconColor: 'text-cyan-600' },
  { value: 'OTHER', label: 'Other', icon: Gift, color: 'from-gray-500 to-gray-600', bgLight: 'bg-gray-50', bgDark: 'dark:bg-gray-800/50', iconColor: 'text-gray-600' },
];
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  <Card className="p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                      Modify the category and name of your goal
                    </p>

                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                      {goalTypes.slice(0, 8).map((type) => {
              ...
              {step === 2 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  <Card className="p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                      Adjust your target and current savings
                    </p>
              ...
              {step === 3 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  <Card className="p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                      Adjust your dates and we'll recalculate your progress
                    </p>
          ...
          <div className="lg:sticky lg:top-6 space-y-6 h-fit">
            ...
            <Card className="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200/50 dark:border-blue-800/50">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-800 dark:text-blue-300 mb-2">Keep Going!</h4>
